...
/* replaced with alternate function for better control.
   basically, I need dumbed down html for wiki parsing, 
   but if I subclass this method there is no way for me to 
   add a failure to the fail count list without going through this method
   as in parent::paintFail($message);
/*
